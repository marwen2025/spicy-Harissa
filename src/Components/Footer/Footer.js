...
const Footer = () => {
  return (
    <div>
        <footer class="w-full text-gray-700 bg-gradient-to-b from-red-800 to-red-900 body-font border-t-red-500 border-t">
        <div
            ...
            <div class="container px-5 py-4 mx-auto">
                <p class="text-sm text-black capitalize text-center">© 2024 All rights reserved
                SpicyHarissa Team </p>
